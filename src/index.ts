...
const COMMANDS = [
  ...
  { command: 'daily', description: "Today's daily puzzle" },
  ...
  { command: 'hint', description: 'Reveal a letter (costs one try)' },
  { command: 'giveup', description: 'End the game and reveal the word' },
  { command: 'stats', description: 'Your stats in this chat' },
  { command: 'top', description: 'Chat leaderboard' },
  { command: 'history', description: 'Recent games in this chat' },
  { command: 'vs', description: 'Head-to-head vs a friend' },
  { command: 'define', description: 'Define the last answer word' },
